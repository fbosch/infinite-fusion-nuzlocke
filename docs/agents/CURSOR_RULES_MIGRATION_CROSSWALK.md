...
| `react-guide.mdc` | skill | `.opencode/skills/react-component-patterns/` | Reusable implementation patterns. |
| `react-state-management.mdc` | skill | `.opencode/skills/react-state-management/` | Reusable state-management guidance. |
