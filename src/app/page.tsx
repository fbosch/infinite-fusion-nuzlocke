            ...
            <div className='flex items-center'>
              <figure className='w-14'>
                ...
                >
                  ...
                  />
                  <path fill='#000' d='M48 68h90v8H48z' />
                  <circle
                    cx='92.6154'
                    cy='71.6154'
                    r='19.5'
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <stop offset='.111111' stop-color='#88E6FF' />
                      <stop offset='.222222' stop-color='#9FBFFF' />
                      <stop offset='.333333' stop-color='#D5A1FF' />
                      <stop offset='.444444' stop-color='#F392CD' />
                      <stop offset='.555556' stop-color='#F3A9B0' />
                      <stop offset='.666667' stop-color='#FACBB5' />
                      <stop offset='.777778' stop-color='#FAE1AF' />
                      <stop offset='.888889' stop-color='#F8F6C2' />
                      <stop offset='1' stop-color='#BFFDB9' />
                    </linearGradient>
                  </defs>
                </svg>
              </figure>
