  ...
  return (
    <div className='bg-gray-50 dark:bg-gray-900 min-h-screen'>
      ...
      <main id='main-content' className='max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8' role='main'>
        ...
        <h1 className="ml-3 text-lg sm:text-xl font-semibold text-cyan-500 dark:text-cyan-400">
          <span className="block text-xl sm:text-2xl font-bold text-cyan-500 dark:text-cyan-400">
            Pokémon Infinite Fusion
          </span>
          <span className="block text-sm sm:text-base font-medium text-gray-900 dark:text-white">
            Nuzlocke Tracker
          </span>
        </h1>
            </div>
