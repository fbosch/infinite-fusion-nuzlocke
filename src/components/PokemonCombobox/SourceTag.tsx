...
> = {
  [EncounterSource.WILD]: {
    text: 'Wild',
    className:
      'transition-all duration-200 text-green-700 dark:text-green-300 bg-green-50 dark:bg-green-900/20 border border-green-200/60 dark:border-green-700/40 hover:bg-green-100 dark:hover:bg-green-900/70',
  ...
  [EncounterSource.FISHING]: {
    text: 'Fish',
    className:
      'transition-all duration-200 text-teal-700 dark:text-teal-300 bg-teal-50 dark:bg-teal-900/20 border border-teal-200/60 dark:border-teal-700/40 hover:bg-teal-100 dark:hover:bg-teal-900/70',
  ...
  [EncounterSource.TRADE]: {
    text: 'Trade',
    className:
      'transition-all duration-200 text-orange-700 dark:text-orange-300 bg-orange-50 dark:bg-orange-900/20 border border-orange-200/60 dark:border-orange-700/40 hover:bg-orange-100 dark:hover:bg-orange-900/70',
    icon: <ArrowUpDown className='size-3' />,
  },
  [EncounterSource.NEST]: {
    text: 'Nest',
    className:
      'transition-all duration-200 text-yellow-700 dark:text-yellow-300 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200/60 dark:border-yellow-700/40 hover:bg-yellow-100 dark:hover:bg-yellow-900/70',
    icon: <NestIcon className='size-3' />,
  },
  [EncounterSource.EGG]: {
    text: 'Egg',
    className:
      'transition-all duration-200 text-cyan-700 dark:text-cyan-300 bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-200/60 dark:border-cyan-700/40 hover:bg-cyan-100 dark:hover:bg-cyan-900/70',
  ...
  [EncounterSource.STATIC]: {
    text: 'Static',
    className:
      'transition-all duration-200 text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/20 border border-gray-200/60 dark:border-gray-700/40 hover:bg-gray-100 dark:hover:bg-gray-900/70',
    icon: <LocateFixed className='size-3' />,
  },
  [EncounterSource.CAVE]: {
    text: 'Cave',
    className:
      'transition-all duration-200 text-stone-700 dark:text-stone-300 bg-stone-50 dark:bg-stone-900/20 border border-stone-200/60 dark:border-stone-700/40 hover:bg-stone-100 dark:hover:bg-stone-900/70',
