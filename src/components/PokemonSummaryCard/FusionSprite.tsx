              ...
              <div>
                <div className='flex flex-col gap-1'>
                  <div className='text-sm flex items-center'>
                    <Palette className='size-3 inline-block mr-1' />
                    <span>{credit}</span>
                  </div>
                  <div className='w-full h-px bg-gray-200 my-1' />
                  <div className='flex items-center justify-between text-xs gap-2'>
                    <div className='flex items-center gap-1'>
                      <div className='flex items-center gap-0.5 px-1 py-px bg-gray-50 border border-gray-200 rounded text-gray-700'>
                        <MousePointer className='size-2.5' />
                        <span className='font-medium text-xs'>L</span>
                      </div>
                      <span className='text-gray-600 text-xs'>Pokédex</span>
                    </div>
                    <div className='flex items-center gap-1'>
                      <div className='flex items-center gap-0.5 px-1 py-px bg-gray-50 border border-gray-200 rounded text-gray-700'>
                        <MousePointer className='size-2.5' />
                      ...
                      <span className='text-gray-600 text-xs'>Options</span>
                    </div>
                  </div>
                </div>
              </div>
