...
export function CookieConsent() {
  ...
  return (
    <>
      ...
      <div className='fixed bottom-0 left-0 right-0 h-64 bg-gradient-to-t from-black/20 to-transparent dark:from-black/40 dark:to-transparent z-40 pointer-events-none' />
