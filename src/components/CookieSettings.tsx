...
export function CookieSettings({ isOpen, onClose }: CookieSettingsProps) {
  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50'>
      <div className='bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl max-w-lg w-full'>
        <div className='p-6'>
          ...
          <div className='space-y-6 mb-6'>
            <div>
              ...
              <p className='text-sm text-gray-600 dark:text-gray-300 mb-6'>
                ...
                These settings will be saved to your browser and you can change
                them at any time.
              </p>
            </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='border border-gray-200 dark:border-gray-600 rounded-lg p-4'>
                ...
                <p className='text-sm text-gray-600 dark:text-gray-300'>
                  These cookies allow us to monitor and improve the performance
                  of our website by collecting information about how the site is
                  used.
                </p>
              </div>
            </div>
